...
function PhoneFrame() {
  return (
    <div className="relative mx-auto hero-anim-float" style={{ width: 280 }}>
      ...
      >
        ...
        <div className="relative h-full rounded-[28px] bg-canvas overflow-hidden flex flex-col">
          ...
          <div className="px-3 pt-2 space-y-1.5 flex-1 overflow-hidden">
            <SubRow color="#E50914" initial="N" name="Netflix" detail="Streaming" amount="$22.99" />
            <SubRow color="#1DB954" initial="S" name="Spotify" detail="Music" amount="$11.99" />
            <SubRow
              color="#FA0F00"
              initial="A"
              name="Adobe CC"
              ...
              flagged
            />
            <SubRow color="#FF9900" initial="A" name="Amazon" detail="Prime annual" amount="$14.99" />
            <SubRow
              color="#5C5CFF"
              initial="P"
              name="Paddle.net"
