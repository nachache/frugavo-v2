...
export async function GET(req: Request) {
  ...
  // Paid-only: the active-learning surface is part of the
  // continuous-monitoring product. Free users can still see the
  // basic dashboard, just not the "help us learn" carousel.
